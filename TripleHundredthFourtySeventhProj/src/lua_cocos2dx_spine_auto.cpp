...
int lua_cocos2dx_spine_SkeletonAnimation_setDefaultMix(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok = true;
...
#if COCOS2D_DEBUG >= 1
    if (!cobj) {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_setDefaultMix'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) {
        double arg0;
        ok &= luaval_to_number(tolua_S, 2, &arg0, "sp.SkeletonAnimation:setDefaultMix");
        if (!ok) {
            tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_setDefaultMix'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:setDefaultMix", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_setDefaultMix'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonAnimation");
        ...
        tolua_function(tolua_S,"setDefaultMix",lua_cocos2dx_spine_SkeletonAnimation_setDefaultMix);
